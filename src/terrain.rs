...
impl Procedural {
    ...
    fn heights(&mut self) -> Map2D<f64> {
        ...
        // SEAMLESS
        //let mix_step = 0.5 / 64.0;
        //for i in 1..64 {
            //for x in 0..hmap.height() {
                //let height = hmap.height() - i;
                //let side_1 = hmap[i - 1][x];
                //let side_2 = hmap[height][x];
                //let factor = 0.5 -  mix_step;
                //let lerp = math::lerp(side_1, side_2, factor);
        ...
        //for i in 0..20 {
            //factor -= mix_step;
            //for x in 0..hmap.height() {
                //let height = hmap.height() - (i+1);
                //let side_1 = hmap[i][x];
                //let side_2 = hmap[height][x];
                //let lerp = math::lerp(side_1, side_2, factor);

                //temp_map[i][x] = lerp;
                //temp_map[height][x] = lerp;
                //println!("{:?}", factor);
            //}
        //}
        ...
        for i in 0..=1 {
            for x in 0..hmap.height() {
                ...
                let side_1 = hmap[i][x];
                let side_2 = hmap[height][x];
                let lerp = math::lerp(side_1, side_2, 0.5);

                hmap[i][x] = lerp;
                hmap[height][x] = lerp;
            }

            for y in 0..hmap.width() {
                let width = hmap.width() - (i+1);
                let side_1 = hmap[y][i];
                let side_2 = hmap[y][width];
                let lerp = math::lerp(side_1, side_2, 0.5);
        ...
        //for x in 0..hmap.height() {
            //let side_1 = hmap[3][x];
            //let side_2 = hmap[4][x];
            //let lerp = math::lerp(side_1, side_2, 0.9);
        ...
        //for x in 0..hmap.height() {
            //let side_1 = hmap[4][x];
            //let side_2 = hmap[5][x];
            //let lerp = math::lerp(side_1, side_2, 0.8);
        ...
        //for x in 0..hmap.height() {
            //let side_1 = hmap[5][x];
            //let side_2 = hmap[6][x];
            //let lerp = math::lerp(side_1, side_2, 0.7);
        ...
        //for x in 0..hmap.height() {
            //let side_1 = hmap[6][x];
            //let side_2 = hmap[7][x];
            //let lerp = math::lerp(side_1, side_2, 0.6);
        ...
        //for x in 0..hmap.height() {
            //let side_1 = hmap[8][x];
            //let side_2 = hmap[9][x];
            //let lerp = math::lerp(side_1, side_2, 0.4);
        ...
        //for x in 0..hmap.height() {
            //let side_1 = hmap[9][x];
            //let side_2 = hmap[10][x];
            //let lerp = math::lerp(side_1, side_2, 0.3);

            //hmap[10][x] = lerp;
        //}

        //for x in 0..hmap.height() {
            //let side_1 = hmap[10][x];
            //let side_2 = hmap[11][x];
            //let lerp = math::lerp(side_1, side_2, 0.2);

            //hmap[11][x] = lerp;
        //}

        //for x in 0..hmap.height() {
            //let side_1 = hmap[11][x];
            //let side_2 = hmap[12][x];
            //let lerp = math::lerp(side_1, side_2, 0.1);
        ...
        //for x in 0..hmap.height() {
            //let side_1 = hmap[height - 1][x];
            //let side_2 = hmap[height - 2][x];
            //let lerp = math::lerp(side_1, side_2, factor);

            //hmap[height - 2][x] = lerp;
        //}

        //for x in 0..hmap.height() {
            //let side_1 = hmap[height - 2][x];
            //let side_2 = hmap[height - 3][x];
            //let lerp = math::lerp(side_1, side_2, factor);

            //hmap[height - 3][x] = lerp;
        //}


        //for x in 0..hmap.height() {
            //let side_1 = hmap[height - 3][x];
            //let side_2 = hmap[height - 4][x];
            //let lerp = math::lerp(side_1, side_2, factor);

            //hmap[height - 4][x] = lerp;
        //}
        ...
        for i in 1..=30 {
            ...
            for x in 0..hmap.height() {
                let side_1 = hmap[height - i][x];
                let side_2 = hmap[height - (i+1)][x];
                let lerp = math::lerp(side_1, side_2, factor);

                hmap[height - (i+1)][x] = lerp;
            }

            for y in 0..hmap.height() {
                let side_1 = hmap[y][width - i];
                let side_2 = hmap[y][width - (i+1)];
                let lerp = math::lerp(side_1, side_2, factor);

                hmap[y][width - (i+1)] = lerp;
            }
        }

        //for x in 0..hmap.height() {
            //let side_1 = hmap[height - 4][x];
            //let side_2 = hmap[height - 5][x];
            //let lerp = math::lerp(side_1, side_2, 0.9);

            //hmap[height - 5][x] = lerp;
        //}


        //for x in 0..hmap.height() {
            //let side_1 = hmap[height - 5][x];
            //let side_2 = hmap[height - 6][x];
            //let lerp = math::lerp(side_1, side_2, 0.8);

            //hmap[height - 6][x] = lerp;
        //}


        //for x in 0..hmap.height() {
            //let side_1 = hmap[height - 6][x];
            //let side_2 = hmap[height - 7][x];
            //let lerp = math::lerp(side_1, side_2, 0.7);

            //hmap[height - 7][x] = lerp;
        //}

        //for x in 0..hmap.height() {
            //let side_1 = hmap[height - 7][x];
            //let side_2 = hmap[height - 8][x];
            //let lerp = math::lerp(side_1, side_2, 0.6);

            //hmap[height - 8][x] = lerp;
        //}


        //for x in 0..hmap.height() {
            //let side_1 = hmap[height - 8][x];
            //let side_2 = hmap[height - 9][x];
            //let lerp = math::lerp(side_1, side_2, 0.5);

            //hmap[height - 9][x] = lerp;
        //}

        //for x in 0..hmap.height() {
            //let side_1 = hmap[height - 9][x];
            //let side_2 = hmap[height - 10][x];
            //let lerp = math::lerp(side_1, side_2, 0.4);

            //hmap[height - 10][x] = lerp;
        //}



        //for x in 0..hmap.height() {
            //let side_1 = hmap[height - 10][x];
            //let side_2 = hmap[height - 11][x];
            //let lerp = math::lerp(side_1, side_2, 0.3);

            //hmap[height - 11][x] = lerp;
        //}


        //for x in 0..hmap.height() {
            //let side_1 = hmap[height - 11][x];
            //let side_2 = hmap[height - 12][x];
            //let lerp = math::lerp(side_1, side_2, 0.2);

            //hmap[height - 12][x] = lerp;
        //}


        //for x in 0..hmap.height() {
            //let side_1 = hmap[height - 12][x];
            //let side_2 = hmap[height - 13][x];
            //let lerp = math::lerp(side_1, side_2, 0.1);

            //hmap[height - 13][x] = lerp;
        //}

        //for y in 0..hmap.width() {
            //hmap[y][0] = hmap[y][hmap.width() - 1];
        //}
